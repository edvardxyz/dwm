...
static const char *fonts[]          = { "Terminess:size=10" };
static const char dmenufont[]       = "Terminess:size=10";
...
static const char *brightnessupcmd[] = { "brightnessctl", "5%+", NULL };
static const char *brightnessdowncmd[] = { "brightnessctl", "5%-", NULL };
