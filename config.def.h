...
static const char *fonts[]          = { "monospace:size=12", "Wuncon Siji" };
...
static const char *brightnessupcmd[] = { "brightness", "+", "5", NULL };
static const char *brightnessdowncmd[] = { "brightness", "-", "5", NULL };
