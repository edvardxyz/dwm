...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { col_gray3, col_gray2,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
...
const char *spcmd3[] = {"st", "-n", "passmenu", "-g", "120x34", "-e", "bash -c passmenu", NULL };
...
static const Rule rules[] = {
	...
	{ NULL,		"passmenu", NULL,	   	   SPTAG(2),   0,		  -1,          1,        -1 },
};
